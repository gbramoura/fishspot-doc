\begin{quadro}[h!]
    ...
    \label{qua:quadro-requisitos-autenticacao-login}}
    ...
    \begin{tabular}{|l!{\vrule width 1pt}p{0.55\textwidth}|c|c|}
        ...
        \hline
        RNF1.2 & A duração do processo de autenticação não deve ser maior do que 60 segundos & Desempenho & Obrigatório \\
        \hline

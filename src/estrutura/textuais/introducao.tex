...
% Falar da pesca esportiva
Com o desenvolvimento tecnológico e com outras diversas transformações, a prática da pesca não mais se restringia apenas a um meio de sustento. Consolidou-se como um esporte, uma forma de lazer ou de relaxamento. Uma das motivações desejadas pelo público reside na diversão, o prazer de capturar um peixe, a emoção do embate com o peixe, e não mais obtenção de alimento.

% Internet proprocionou oque?
Nos dias atuais, a presença da internet proporcionou que novos recursos e convenções fossem criados para aumentar ainda mais a eficiencia da pesca. Temos como exemplo, a introdução de recursos de Internet das Coisas (IoT) para monitoramento e tambem o uso de inteligência artificial (IA) para mapeamento preciso dos cordumes de peixes, como descrito por \citeonline{nassiff2025frota}.

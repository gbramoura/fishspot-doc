...
Nos dias atuais, a presença da internet proporcionou que novos recursos e convenções fossem criados para aumentar ainda mais a eficiência da pesca. Temos como exemplo, a introdução de recursos de Internet das Coisas (IoT) para monitoramento e também o uso de inteligência artificial (IA) para mapeamento preciso dos cordumes de peixes, como descrito por \citeonline{nassiff2025frota}.

Como aborado por \citeonline{skov2021expert}, outros recursos modernos, como aplicativos móveis e plataformas web, também estão começando a contribuir para aumentar o compartilhamento de informações entre a comunidade de pescadores, com o intuito de melhorar os costumes pesqueiros e aumentar e eficiência.

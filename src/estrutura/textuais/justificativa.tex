...
Embora existam algumas aplicações com esse propósito, é raro possuírem experiência de usuário (UX, \textit{User Experience}) de acordo com as necessidades de usuários de diversas idades e nichos, em sua maioria, frequentemente disponíveis sem tradução completa para a língua portuguesa. O uso das ferramentas que buscam ser compreensíveis se torna algo complexo, de difícil aprendizado, impedindo o desfruto de momentos de lazer proporcionados pela pesca ao pescador.

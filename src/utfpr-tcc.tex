...
\include{estrutura/textuais/justificativa}                            % Justificativa
\include{estrutura/textuais/objetivos}                                % Objetivos

\include{estrutura/textuais/metodologia}                              % Metodologia
\include{estrutura/textuais/referencial-teorico}                      % Referencial teorico
\include{estrutura/textuais/desenvolvimento}                          % Desenvolvimento
\include{estrutura/textuais/resultado}                                % Resultado
